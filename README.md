...
component based program and it helps better manage large applications that have changes or state changes 
...
anything that affects something outside of the scope of the current function that's being executed Synchronize State with Side 

sync Effects with the useEffect Hooks
